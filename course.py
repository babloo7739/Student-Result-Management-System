...
class CourseClass:
    def __init__(self, root):
        ...
        Entry(self.root, textvariable=self.var_charges, font=("goudy old style", 15, 'bold'), bg="lightyellow").place(x=150, y=140, width=200)  # Corrected variable
       ...
       # Content Frame and Scrollbars
        ...
        self.CourseTable.column("description", width=200)  # Increased width
    ...
    def get_data(self, ev):
        self.txt_courseName.config(state="readonly")#course name not change
        r = self.CourseTable.focus()
        content = self.CourseTable.item(r)
        row = content["values"]
        #print(row)
